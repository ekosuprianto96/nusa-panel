...
const fetchDomains = async () => {
    try {
        ...
        error.value =
            'Failed to load domains. Please ensure you have added a domain first.';
    } finally {
        ...
        <div class="max-w-5xl mx-auto space-y-8 animate-in">
            ...
            <div>
                ...
                <p class="text-muted-foreground mt-1 text-sm">
                    Deploy popular applications to your domains in seconds.
                </p>
            </div>
            ...
            <div
                v-if="successMsg"
                class="bg-emerald-50 text-emerald-600 border border-emerald-200 p-4 rounded-xl flex items-center gap-3 animate-in"
            >
                ...
                <div>
                    ...
                    <p class="text-sm opacity-90">
                        {{ successMsg }} Check your email for details.
                    </p>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div
                    ...
                    :class="[
                        'cursor-pointer border-2 rounded-2xl p-6 transition-all hover:scale-[1.02] relative overflow-hidden',
                ...
                >
                    <div
                        :class="[
                            'w-12 h-12 rounded-xl flex items-center justify-center text-white font-bold text-xl mb-4',
                            app.color,
                        ]"
                    >
                        {{ app.name[0] }}
                    ...
                    <div
                        v-if="selectedApp.id === app.id"
                        class="absolute top-4 right-4 text-primary"
                    >
                        <div
                            class="w-6 h-6 bg-primary rounded-full flex items-center justify-center text-primary-foreground"
                        >
                            <Check class="w-4 h-4" />
                        </div>
                    </div>
            ...
            <!-- Installation Form -->
            <div
                class="bg-card border border-border rounded-2xl p-8"
                v-if="!successMsg"
            >
                ...
                <div class="grid gap-6 md:grid-cols-2">
                    ...
                    <div class="space-y-4">
                        <label class="block text-sm font-medium text-foreground"
                            >Installation Destination</label
                        >
                        <div
                        ...
                        <p
                            v-if="domains.length === 0 && !isLoadingDomains"
                ...
                <div
                    v-if="error"
                    class="mt-6 p-4 bg-destructive/10 text-destructive rounded-lg flex items-center gap-2 text-sm"
                >
